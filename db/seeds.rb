...
#   },
#   {
#     line1: "13000 Highway 244",
#     line2: "Building 31, Suite 1",
#     city: "Keystone",
#     state: "South Dakota",
#     zipcode: "57751",
#     park_id: 55
...
#   },
#   {
#     line1: "1450 Pennsylvania Ave., NW",
#     line2: "",
#     city: "Washington",
#     state: "District Of Columbia",
#     zipcode: "20230",
...
#   },
#   {
#     line1: "Public Information Office",
#     line2: "PO Box 577",
#     city: "Yosemite",
#     state: "California",
#     zipcode: "95389",
...
#   {
#     cost: "20.00",
#     description: "Per vehicle fee (cars, mini-vans, etc..), valid for 7 days.",
#     title: "Vehicle Entrance Fee",
#     park_id: 13
#   },
#   {
#     cost: "15.00",
#     description: "The motorcycle entrance fee is valid for 7 days and is a per motorcycle fee.",
#     title: "Motorcyles",
#     park_id: 13
#   },
#   {
#     cost: "10.00",
#     description: "Pedestrians entering the park on foot or bicycle will pay $10 per person. Valid for 7 days.",
#     title: "Walk-in/Bicycle-in Per Person",
#     park_id: 13
#   },
#   {
#     cost: "",
...
#     title: "Commercial Tour Vehicles",
#     park_id: 13
#   },
#   {
#     cost: "40.00",
#     description: "Park-specific pass. Admits pass holder and all persons in a single, private, non-commercial vehicle to Canaveral National Seashore. Valid for 12 months from when the pass is purchased.",
#     title: "Canaveral National Seashore Annual Pass",
#     park_id: 13
#   },
#   {
#     cost: "30.00",
...
#   {
#     cost: "35.00",
#     description: "This pass covers the entrance fees to Capitol Reef National Park of the pass holder and occupants of a single, private non-commercial vehicle. It is valid for 365 days from the date of purchase.",
...
#   {
#     cost: "30.00",
#     description: "Commercial vehicles with a capacity of 1 to 6 passengers are required to pay a $30 entrance fee, plus a $15 per passenger fee. The entrance fee structure for commercial vehicles visiting national parks is based on the capacity of the vehicle you arrive in, not the number of passengers. This fee is valid for 7 consecutive days with the same company and the same passengers.",
...
#   {
#     cost: "10.00",
#     description: "This per-person fee is valid for seven consecutive days.",
#     title: "Entrance Fee - Adults 16 and over",
#     park_id: 23
#   },
#   {
#     cost: "9.00",
#     description: "Permit is good for one night at Yankee Paradise Campground. This is a wilderness campground. Camping must be in the designated campground area but specific sites are not assigned. Permit is good for up to 6 people.",
#     title: "Yankee Paradise Campground",
#     park_id: 23
#   },
#   {
#     cost: "12.00",
#     description: "Permit fee is for one night, for an individual campsite at Stafford Beach Campground. Permit is good for up to six people.",
#     title: "Stafford Beach Campground",
#     park_id: 23
#   },
#   {
#     cost: "40.00",
#     description: "Permit fee is good for one night at a designated groupsite at Sea Camp Campground. Permit is good for 7 - 20 people.",
#     title: "Sea Camp Groupsite",
#     park_id: 23
#   },
#   {
#     cost: "22.00",
#     description: "Permit fee is per night, for an individual campsite at the Sea Camp Campground. Permits are good for up to six people.",
#     title: "Sea Camp Campground",
#     park_id: 23
#   },
#   {
#     cost: "9.00",
#     description: "Permit is good for one night at Hickory Hill Campground. This is a wilderness campground. Camping must be in the designated campground area but specific sites are not assigned. Permit is good for up to 6 people.",
#     title: "Hickory Hill Campground",
#     park_id: 23
#   },
#   {
#     cost: "9.00",
#     description: "Permit is good for one night at Brickhill Bluff Campground. This is a wilderness campground. Camping must be in the designated campground area but specific sites are not assigned. Permit is good for up to 6 people.",
#     title: "Brickhill Bluff Campground",
#     park_id: 23
#   },
#   {
#     cost: "28.00",
#     description: "A senior (62 years and up) roundtrip ticket is $28 plus 7% GA sales tax.",
#     title: "Senior Ferry Ticket",
#     park_id: 23
#   },
#   {
#     cost: "30.00",
#     description: "An adult (16-61) roundtrip ferry ticket is $30, plus 7% GA sales tax",
#     title: "Adult Ferry Ticket",
#     park_id: 23
#   },
#   {
#     cost: "0.00",
#     description: "Children 5 and younger are free. They still need to have a reservation to be counted in the passenger manifest.",
#     title: "Child Ferry Ticket",
#     park_id: 23
#   },
#   {
#     cost: "20.00",
#     description: "A youth (6-15 years) is $20 plus 7% GA sales tax.",
#     title: "Youth Ferry ticket",
#     park_id: 23
#   },
#   {
#     cost: "35.00",
#     description: "The pass is good for one calendar year from month of purchase. The pass admits only the pass holder.",
#     title: "Cumberland Island National Seashore Annual Pass",
#     park_id: 23
#   },
#   {
#     cost: "0.00",
...
#   {
#     cost: "25.00",
#     description: "Fee for a single, private, non-commercial vehicle and all its passengers.",
#     title: "Entrance Fee, 1-7 Day Vehicle Pass",
#     park_id: 27
#   },
#   {
#     cost: "20.00",
#     description: "Fee for a single motorcycle and operator/passenger.",
#     title: "Entrance Fee, 1-7 Day Motorcycle Pass",
#     park_id: 27
#   },
#   {
#     cost: "15.00",
#     description: "Admits one individual when entering on foot or bicycle. Individuals 15 years of age or younger are admitted free. This may also be used to calculate cost for organized non-profit groups (service organizations, scout groups, religious groups, etc.)",
#     title: "Entrance Fee, 1-7 Day Individual Permit",
#     park_id: 27
#   },
#   {
#     cost: "25.00",
#     description: "These entrance fees are based upon the seating capacity of the commercial tour vehicle - not the actual number of passengers. The fee is $25 plus $15/person, not to exceed $40.",
#     title: "Commercial Tours (seating capacity 1-6 people)",
#     park_id: 27
#   },
#   {
#     cost: "40.00",
#     description: "These entrance fees are based upon the seating capacity of the commercial tour vehicle - not the actual number of passengers.",
#     title: "Commercial Tours (seating capacity 7-25 people)",
#     park_id: 27
#   },
#   {
#     cost: "100.00",
#     description: "These entrance fees are based upon the seating capacity of the commercial tour vehicle - not the actual number of passengers.",
#     title: "Commercial Tours (seating capacity 26 or more people)",
#     park_id: 27
#   },
#   {
#     cost: "45.00",
#     description: "Valid for 12 months from date of purchase, for entry into Devils Tower National Monument only.",
#     title: "Devils Tower National Monument Annual Pass",
#     park_id: 27
#   },
#   {
#     cost: "15.00",
...
#   {
#     cost: "0.00",
#     description: "Hot Springs National Park does not have entrance fees.",
#     title: "Entrance Fee",
#     park_id: 43
#   },
#   {
...
#     title: "est Beach - Senior Pass Entrance Fee (Currently No Charge*)",
#     park_id: 44
#   },
#   {
#     cost: "3.00",
...
#   {
#     cost: "60.00",
#     description: "Valid from April 16 - October 31 of the year indicated. Covers the entrance fee ($7 per person per day) for the person whose signature appears on the pass and up to 3 adults (aged 16 and up) traveling with the pass holder. Non-refundable and non-transferable. Can be obtained in-person from the Houghton, Rock Harbor, or Windigo Visitor Centers or online.",
#     title: "Isle Royale Season Pass",
#     park_id: 45
#   },
#   {
#     cost: "30.00",
#     description: "-day vehicle permit, admitting the passengers of a single, non-commercial vehicle on the day of purchase and for the next six days.",
#     title: "Entrance Fee",
#     park_id: 46
#   },
#   {
...
#   {
#     cost: "0.00",
#     description: "There is no entrance fee for Katmai National Park & Preserve.",
#     title: "Entrance Fee",
#     park_id: 47
#   },
#   {
...
#   {
#     cost: "0.00",
#     description: "There is no entrance fee to visit Lake Clark National Park & Preserve",
#     title: "Entrance Fee",
#     park_id: 50
#   },
#   {
...
#   {
#     cost: "15.00",
#     description: "This is a per-person (bicyclist and individual) entrance fee for the summer season (May 1 to October 31, 2020). It is valid for seven days from the day of purchase. Please note that we offer fee waivers for qualified education groups.",
#     title: "Mesa Verde Entrance Fee - Per Person - Summer Season",
#     park_id: 53
#   },
#   {
#     cost: "20.00",
#     description: "This is a per-vehicle entrance fee for fall/winter/spring (January 2 to April 30, 2020 and November 1 to December 31, 2020). It is valid for seven days from the day of purchase. Please note that we offer fee waivers for qualified education groups.",
...
#   {
#     cost: "20.00",
#     description: "Fee per site, nightly, for camping in Cougar Rock, Ohanapecosh, and White River campgrounds.",
#     title: "Mount Rainier Campground Fee",
#     park_id: 54
#   },
#   {
#     cost: "60.00",
#     description: "Fee for group sites, nightly, in Cougar Rock and Ohanapecosh campgrounds. Group sites accommodate 25 to 40 people depending on site. There are no group sites in White River Campground.",
...
#   {
#     cost: "0.00",
#     description: "There is no entrance fee for Mount Rushmore National Memorial. However, fees are required to park at the memorial.",
#     title: "Mount Rushmore Entrance Fee",
#     park_id: 55
#   },
#   {
#     cost: "10.00",
#     description: "Parking fee is for private passenger vehicles, valid for one year from date of purchase.  Parking fee for Seniors, 62 and older, is $5 and Active Duty Military parking is free.",
#     title: "Mount Rushmore Parking Fee - private vehicles",
#     park_id: 55
#   },
#   {
#     cost: "50.00",
#     description: "Valid for 24 hours from time of purchase.  Annual Pass, Annual Pass - Military, Senior Pass, Access Pass and Every Kid Outdoors Pass do not apply.",
#     title: "Mount Rushmore Parking Fee - Commercial Bus",
#     park_id: 55
#   },
#   {
#     cost: "25.00",
#     description: "Valid for 24 hours from time of purchase.  Annual Pass, Annual Pass - Military, Senior Pass, Access Pass and Every Kid Outdoors Pass do not apply.",
#     title: "Mount Rushmore Parking Fee - School Bus",
#     park_id: 55
#   },
#   {
#     cost: "0.00",
#     description: "All of the Sites within National Mall and Memorial Parks are FREE. The only exception is if you wish to reserve tickets ahead of time for the Washington Monument.",
#     title: "Entrance Fee",
#     park_id: 56
#   },
#   {
#     cost: "0.00",
#     description: "No fees or reservations are required to visit the National Park Of American Samoa",
#     title: "Entrance Fee",
#     park_id: 57
#   },
#   {
...
#   {
#     cost: "0.00",
#     description: "There are no entrance fees to visit New River Gorge National Park & Preserve.",
#     title: "Entrance Fee",
#     park_id: 59
#   },
#   {
#     cost: "0.00",
#     description: "There are no entrance fees to visit North Cascades National Park.",
#     title: "Entrance Fee",
#     park_id: 60
#   },
#   {
...
#   {
#     cost: "0.00",
#     description: "There is no entrance fee to visit Pictured Rocks National Lakeshore",
#     title: "Entrance Fee",
#     park_id: 63
#   },
#   {
...
#   {
#     cost: "0.00",
#     description: "There is no fee to visit any area in President's Park (White House).",
#     title: "Entrance Fee",
#     park_id: 65
#   },
#   {
...
#   {
#     cost: "70.00",
#     description: "his pass is valid for Sequoia & Kings Canyon National Parks and Hume Lake Ranger District of Sequoia National Forest/Giant Sequoia National Monument for one year from the month of purchase. The pass admits all passengers in a private vehicle and is non-transferable.",
...
#   {
#     cost: "0.00",
#     description: "There is no entrance fee to visit Voyageurs National Park. Camping amenity fees are separate.",
#     title: "Entrance Fee",
#     park_id: 73
#   },
#   {
...
#   {
#     cost: "15.00",
#     description: "Per person fee is only charged if there is only one adult (16 years or older) in the vehicle. Entrance fees are valid for entry for seven consecutive days from the date of purchase.",
...
#   {
#     cost: "0.00",
#     description: "There are no fees to drive through or hike in the park.",
#     title: "Entrance Fee",
#     park_id: 75
#   },
#   {
...
#   {
#     cost: "12.00",
#     description: "Half price for children 8*-16 and for Senior (Golden Age)/Access pass holders. Reservations strongly recommended. *Minimum age for Candlelight Tour is 8 years old.",
#     title: "",
#     park_id: 75
#   },
#   {
...
#   {
#     cost: "0.00",
#     description: "There is no entrance fee to visit Wrangell-St. Elias National Park & Preserve.",
#     title: "Entrance Fee",
#     park_id: 76
#   },
#   {
...
#   {
#     cost: "125.00",
#     description: "Commercial Tour (van, 7-15 seats, regardless of occupancy)",
#     title: "Commercial Tour (van, 7-15 seats, regardless of occupancy)",
#     park_id: 78
#   },
#   {
#     cost: "200.00",
#     description: "Commercial Tour (mini bus, 16-25 seats, regardless of occupancy)",
#     title: "Commercial Tour (mini bus, 16-25 seats, regardless of occupancy)",
#     park_id: 78
#   },
#   {
#     cost: "300.00",
#     description: "Commercial Tour (motor coach, 26 or more seats, regardless of occupancy)",
...
Image.create([
  {
    ...
    alt_text: "A brilliant sunset filled with hues of blue, red, orange, magenta, and purple highlight the sky.",
  ...
  },
  {
    ...
    alt_text: "Large puffy clouds dot a brilliant blue sky as wave crash against the rocky coastline of Acadia.",
  ...
  },
  {
    ...
    alt_text: "Two hikers ascend a sheer cliff trail by way of historic iron rung ladders.",
  ...
  },
  {
    ...
    alt_text: "Hiking tracks carved through three feet of snow wind through a heavy snow-laden forest.",
    caption: "uring the colder months snows transform our landscape into a winter wonderland.",
  ...
  },
  {
    credit: "NPS / Kristi Rugg",
    title: "Starviewing",
    alt_text: "A man peers into a telescope as the Milky Way lights up the night sky.",
  ...
  },
  {
    ...
    alt_text: "Tree-covered red cliffs meet greenish blue water, in a bowl shape.",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Ice Caves",
    alt_text: "Sunlight shines through a cave hole surrounded by icicles onto the frozen lake surface",
  ...
  },
  {
    ...
    alt_text: "A two story white house with a light tower in the middle, reflects the colors of the setting sun.",
  ...
  },
  {
    ...
    title: "Julian Bay",
    alt_text: "Sunrise illuminates a long beach near calm water.",
  ...
  },
  {
    ...
    alt_text: "A rocky shoreline meets the calm water of a lake at sunset.",
  ...
  },
  {
    ...
    alt_text: "a stone monolith reflected in standing water",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Double O Arch",
    alt_text: "a broad, red arch with rock pinnacles in the background",
  ...
  },
  {
    ...
    alt_text: "the Milky Way arcs above silhouetted stone pinnacles",
  ...
  },
  {
    ...
    alt_text: "two hikers descend a broad wash with tall rock walls on either side.",
  ...
  },
  {
    ...
    alt_text: "Wild horses on the dunes at Assateague",
  ...
  },
  {
    ...
    alt_text: "Wild horses in the salt marshes on Assateague Island",
  ...
  },
  {
    ...
    alt_text: "Tree Swallows migrating along the beach at Assateague",
  ...
  },
  {
    ...
    alt_text: "tents and vehicle in the oceanside campground dunes",
  ...
  },
  {
    ...
    alt_text: "waves on Assateague beach with people fishing in the background",
  ...
  },
  {
    ...
    alt_text: "Layered badlands formations behind fields of green grass under cloudy and billowing clouds.",
  ...
  },
  {
    ...
    alt_text: "The yellow mounds are peaking out of the formations in this photo.",
  ...
  },
  {
    ...
    alt_text: "Badlands formations are very rugged and often have sharp peaks.",
  ...
  },
  {
    ...
    alt_text: "Jagged badlands buttes extended in horizon amid yellow flowers under a blue sky.",
  ...
  },
  {
    ...
    alt_text: "road leading between snow covered badlands formations",
  ...
  },
  {
    credit: "NPS / Roy Wood",
    title: "Wet Muskox",
    alt_text: "Three wet muskox stand in a line.",
  ...
  },
  {
    ...
    title: "Fall Colors",
    alt_text: "A hiker is seen in the distance as autumn colors dominate the tundra landscape.",
  ...
  },
  {
    ...
    alt_text: "Rolling sand dunes with sparse vegetation with full moon rising above.",
  ...
  },
  {
    ...
    alt_text: "A vast expanse of undulating hills with granite spire jutting from the top.",
  ...
  },
  {
    ...
    alt_text: "Flock of shore birds taking flight",
  ...
  },
  {
    ...
    alt_text: "a Florida Panther sits in a tree",
  ...
  },
  {
    ...
    alt_text: "Two Alligators rest on a river bank",
  ...
  },
  {
    ...
    alt_text: "two visitors in a canoe go through mangrove tunnels on the Turner River",
  ...
  },
  {
    ...
    alt_text: "A prairie foreground with tall pine trees in the background. A large blue sky with white cloud",
  ...
  },
  {
    ...
    alt_text: "palm trees emerge out of the fog in an orange sunrise",
    caption: "Palm trees emerge out of the fog in an orange sunrise.",
  ...
  },
  {
    ...
    alt_text: "a stand of young longleaf pines growing near each other",
  ...
  },
  {
    ...
    alt_text: "A woman and her dog on a metal bridge spanning a creek lined with bald cypress trees.",
  ...
  },
  {
    ...
    title: "Cypress Knees",
    alt_text: "Knobby cypress knees resembling cave stalagmites protrude up from a pool of water.",
  ...
  },
  {
    credit: "NPS Photo / Scott Sharaga",
    title: "Palmettos",
    alt_text: "palmetto plants growing in the forest",
  ...
  },
  {
    ...
    alt_text: "A dense stand of funnel-shaped carnivorous pitcher plants awaiting their next insect meal.",
  ...
  },
  {
    ...
    title: "Snorkeling",
    alt_text: "Coral reef with two snorkelers diving below the surface",
  ...
  },
  {
    credit: "NPS image by Shaun Wolfe",
    title: "Coral Reef",
    alt_text: "Underwater view of coral reef with a large school of yellow and blue fish",
  ...
  },
  {
    credit: "NPS photo",
    title: "Coral Reef",
    alt_text: "The coral reefs are located mostly on the Eastern side of the park.",
  ...
  },
  {
    credit: "NPS photo",
    title: "Totten Key",
    alt_text: "Aerial view of Totten Key",
  ...
  },
  {
    ...
    alt_text: "Black Canyon near Tomichi Point",
  ...
  },
  {
    ...
    alt_text: "Black Canyon near Painted Wall",
  ...
  },
  {
    ...
    alt_text: "A red rock landscape and plateau forest glows with the morning sun",
  ...
  },
  {
    ...
    alt_text: "Snow blankets a red rock landscape of tall rock spires beneath an early morning sky",
  ...
  },
  {
    ...
    alt_text: "The center of the Milky Way galaxy is seen rising above a horizon of forest and red rock spires",
  ...
  },
  {
    ...
    alt_text: "A lone white rock tower stands surrounded by red rock walls and forest along a trail",
  ...
  },
  {
    ...
    alt_text: "Red and white rock cliffs lightly dusted with snow with a forest atop them and a long view beyond",
  ...
  {
    credit: "NPS Photo/Anthony J Peritore",
    title: "Canaveral National Seashore for Rocket Viewing",
    alt_text: "Falcon Heavy Launch",
    caption: "Get an up close view of a rocket launch!",
    url: "https://www.nps.gov/common/uploads/structured_data/E60D4A6A-1DD8-B71B-0BF9CE5876DFC9CE.jpg",
    park_id: 13
  },
  {
    credit: "nps/photo",
    title: "Roseate Spoonbills",
    alt_text: "Roseate Spoonbills",
    caption: "Roseate Spoonbills.",
    url: "https://www.nps.gov/common/uploads/structured_data/1DFD7185-FE5F-034A-2F1C95FF8C2A899F.jpg",
    park_id: 13
  },
  {
    credit: "nps/photo",
    title: "Sea Turtle Nests",
    alt_text: "Sea Turtle Nests",
    caption: "Sea Turtle Nests.",
    url: "https://www.nps.gov/common/uploads/structured_data/1E17BC26-9EAB-422F-F95B84D5E5590966.jpg",
    park_id: 13
  },
  {
    credit: "nps/photo",
    title: "Canaveral National Seashore",
    alt_text: "Seashore in the evening.",
    caption: "Seashore in the evening.",
    url: "https://www.nps.gov/common/uploads/structured_data/1E279FD6-E2E2-FEE5-705E3CB43DCD24C4.jpg",
    park_id: 13
  },
  {
    credit: "L. Peters",
    title: "Mosquito Lagoon",
    alt_text: "Image of mosquito lagoon viewed from one of Playalinda's vistas",
    caption: "Discover the pristine beauty of Canaveral National Seashore",
    url: "https://www.nps.gov/common/uploads/structured_data/460BD730-1DD8-B71B-0B1E431754E74498.jpg",
    park_id: 13
  },
  {
    credit: "NPS/Neal Herbert",
    title: "Mesa Arch",
    alt_text: "a broad stone arch with rock pinnacles in the distance",
  ...
  },
  {
    credit: "NPS/Neal Herbert",
    title: "Pothole Point",
    alt_text: "shallow pools with a double rainbow in the background",
  ...
  },
  {
    ...
    alt_text: "a long gravel road with cyclists on it",
  ...
  },
  {
    ...
    alt_text: "pinnacles of horizontally striped sandstone",
  ...
  },
  {
    credit: "NPS image",
    title: "Sunrise Waves",
    alt_text: "A curling wave breaks against the backdrop of a pink sunrise.",
  ...
  },
  {
    credit: "NPS photo",
    title: "Sand Ripples",
    alt_text: "Low tide exposes rippled ridges of sand and water.",
  ...
  },
  {
    ...
    alt_text: "A red kayak floats on a pond facing a forest colored with red and orange leaves",
  ...
  },
  {
    ...
    alt_text: "A flock of birds flies along a beach with waves in the background",
  ...
  },
  {
    ...
    alt_text: "A brilliant sun rises over the ocean reflecting light on the water's surface",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Fresnel Lens",
    alt_text: "The first-order Fresnel lens is visible in the lantern room of the Bodie Island Lighthouse.",
  ...
  },
  {
    ...
    alt_text: "A young girl paddles across the water with the Cape Hatteras Lighthouse visible in the distance",
  ...
  },
  {
    ...
    alt_text: "Black and white painting of the brick Cape Hatteras Lighthouse",
  ...
  },
  {
    ...
    alt_text: "Two kids play in the sand.",
  ...
  },
  {
    ...
    alt_text: "Black & white patterned tower of the Cape Lookout Lighthouse stands against a blue & white cloud f",
  ...
  },
  {
    credit: "NPS photo",
    title: "Sea Oats",
    alt_text: "Mature sea oat plant seed heads gracefully drooping in the sun",
  ...
  },
  {
    credit: "NPS photo",
    title: "Sanderlings",
    alt_text: "small sandpipers poke their bills in the sand while waves break in the background",
    caption: "mall sandpipers, called Sanderlings, are common sights on the ocean beach as they search for food in the sand between waves.",
  ...
  },
  {
    credit: "NPS photo",
    title: "",
    alt_text: "Relaxing by the Ocean",
    caption: "2 ladies sit in beach chairs on the sand with their feet in the water",
    url: "Watching the waves, feeling the cool sea breeze and the warmth of the sun make for a relaxing day.",
    park_id: 17
  },
  {
    credit: "NPS photo",
    title: "Surf fishing",
    alt_text: "A surf fisherman stands in the water holding his surf rod and watching the waves",
  ...
  },
  {
    ...
    alt_text: "Wingate Sandstone cliffs behind historic barn and farmhouse",
  ...
  },
  {
    ...
    alt_text: "A hiker stands beside Hickman Bridge, a natural sandstone bridge",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Strike Valley",
    alt_text: "Exposed layers of rock in the Waterpocket fold",
  ...
  },
  {
    ...
    alt_text: "Cliffs known as \"The Castle\" tower above the Capitol Reef Visitor Center",
  ...
  },
  {
    ...
    alt_text: "Fruit tree with peaches in front of red sandstone cliffs",
  ...
  },
  {
    ...
    alt_text: "Looking up through the mouth of the cave on the Natural Entrance path",
  ...
  },
  {
    credit: "NPS Photo by Peter Jones",
    title: "Rock of Ages",
    alt_text: "Visitors rest at the formation \"Rock of Ages.\"",
  ...
  },
  {
    ...
    alt_text: "Visitors gathered in the outdoor amphitheater to experience bat flight.",
  ...
  },
  {
    ...
    alt_text: "Visitors watch as droplets ripple through a cave pool",
  ...
  },
  {
    ...
    alt_text: "\"The Chandelier\" is spotlighted in this photo taken inside the Big Room.",
  ...
  },
  {
    ...
    alt_text: "Steep, rugged ocean cliffs extending in an island chain",
  ...
  },
  {
    ...
    alt_text: "Yellow flowers in foreground extending out along a rocky coastline to a natural arch.",
  ...
  },
  {
    ...
    alt_text: "Pine tree high on a ridge overlooking a bay with blue water and white sand beach.",
  ...
  },
  {
    ...
    alt_text: "Brown seals and sea lions on white sand beach with blue water and partly cloudy sky.",
  ...
  },
  {
    ...
    alt_text: "Rust and grey colored fox in green grass",
  ...
  },
  {
    ...
    alt_text: "View of the Congaree River during the Fall",
  ...
  },
  {
    ...
    alt_text: "Clouds in the Crater Lake Caldera.",
  ...
  },
  {
    ...
    alt_text: "A view of Crater Lake in the winter",
  ...
  },
  {
    ...
    alt_text: "Wildflowers on Wizard Island",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Vidae Falls",
    alt_text: "water flowing over Vidae Falls",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Crater Lake",
    alt_text: "A view across Crater Lake from the lakeshore",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Tidal Creek",
    alt_text: "tidal creek at low tide surrounded by palm and oak trees",
    caption: "Rising tides bring valuable nutrients into tidal creeks, while receding tides remove waste. This makes the tide cycle the beating heart of the island’s tidal creeks, salt marshes, and estuaries.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C806748-1DD8-B71B-0B9947D4C0E897DE.jpg",
    park_id: 23
  },
  {
    credit: "NPS Photo",
    title: "The Settlement",
    alt_text: "small white one room church, old red house in the background, under cloudy skies",
    caption: "The remote north end of the island is home to the First African Baptist Church and The Settlement, where African American residents were able to purchase their first deeded property on the island at the end of the 1800s.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C8065C5-1DD8-B71B-0B3CC16BCC695D70.jpg",
    park_id: 23
  },
  {
    credit: "NPS Photo",
    title: "Undeveloped Coast",
    alt_text: "Ocean beach at sunrise",
    caption: "Cumberland Island National Seashore encompasses nearly 18 miles of undeveloped beach offering recreation for visitors and essential nesting area for birds and sea turtles.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C804293-1DD8-B71B-0B3C50A212C19199.jpg",
    park_id: 23
  },
  {
    credit: "NPS Photo",
    title: "Plum Orchard Mansion",
    alt_text: "large, white mansion behind oak trees draped with Spanish Moss",
    caption: "Visitors can take a guided tour of the Plum Orchard Mansion and experience the luxuries of Victorian high society as well as the effort and ingenuity it took to make it possible.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C804721-1DD8-B71B-0B674DD331D1FC2B.jpg",
    park_id: 23
  },
  {
    credit: "NPS Photo",
    title: "Island Bluffs Shaped By Tides",
    alt_text: "rippled sands of a beach in front of pine tree covered bluffs",
    caption: "Tidal forces continue to shape the land today as they have for thousands of years forming high bluffs used for fortifications and ship docking throughout the island’s history.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C805318-1DD8-B71B-0BEE73A8A7441F08.jpg",
    park_id: 23
  },
  {
    credit: "NPS Photo / D.J. Reiser",
    title: "Kayakers on the Cuyahoga River",
    alt_text: "People in bright orange kayaks paddle around a bend in a river, past green trees and a rocky shore.",
  ...
  },
  {
    ...
    alt_text: "Two people stand at the edge of a gray rock cliff; in the distance, sunset and trees in fall colors.",
  ...
  },
  {
    ...
    alt_text: "A yellow-and-red engine with number 6777 leads a passenger train along tracks through green trees.",
  ...
  },
  {
    ...
    alt_text: "Viewed from above, people stand on a platform near frothy white water falling over a rocky ledge.",
  ...
  },
  {
    ...
    alt_text: "Visitors line the concrete edge of a canal lock filled with water, in front of a white building.",
  ...
  },
  {
    ...
    alt_text: "a field of yellow flowers with a mountain",
  ...
  },
  {
    ...
    alt_text: "thermometer reading 130 f 54 c",
  ...
  },
  {
    ...
    alt_text: "pink lupine flowers with an orange and black butterfly",
  ...
  },
  {
    ...
    alt_text: "a sunset overlooking a valley filled with white salt",
  ...
  },
  {
    ...
    alt_text: "white salt flats with dark gray clouds",
  ...
  },
  {
    ...
    alt_text: "a large seated crowd faces a park ranger and a small group of sled dogs",
  ...
  },
  {
    ...
    alt_text: "a bus on a gravel road behind a large caribou that is trotting on the road",
  ...
  },
  {
    credit: "NPS Photo / Emily Mesner",
    title: "Grizzlies",
    alt_text: "three brown bears walking along a dirt road",
  ...
  },
  {
    ...
    title: "Dall Sheep",
    alt_text: "a white colored sheep standing on a mountainside overlooking a green valley",
  ...
  },
  {
    credit: "NPS Photo / Emily Mesner",
    title: "Alpenglow",
    alt_text: "light turns a snowy mountain shades of pink and purple",
  ...
  {
    credit: "NPS/ S. Carter",
    title: "Devils Tower looming above the trees",
    alt_text: "Devils Tower looming above the trees",
    caption: "Devils Tower looming above the trees.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C812956-1DD8-B71B-0B0AB4D807441C9D.jpg",
    park_id: 27
  },
  {
    credit: "NPS/ S. Carter",
    title: "Devils Tower from the Joyner Ridge Trail",
    alt_text: "Devils Tower from the Joyner Ridge Trail",
    caption: "Devils Tower from the Joyner Ridge Trail.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C812B21-1DD8-B71B-0B46E0A561AF4ABA.jpg",
    park_id: 27
  },
  {
    credit: "NPS/ S. Carter",
    title: "Fall at Devils Tower",
    alt_text: "Fall at Devils Tower",
    caption: "Fall at Devils Tower.",
    url: "",
    park_id: 27
  },
  {
    credit: "NPS",
    title: "Prairie dogs at Devils Tower",
    alt_text: "Prairie dogs at Devils Tower",
    caption: "Prairie dogs at Devils Tower.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C812E11-1DD8-B71B-0BB94F4B2FEAAEE7.jpg",
    park_id: 27
  },
  {
    credit: "NPS/ S. Carter",
    title: "Devils Tower overlooking the Circle of Sacred Smoke Sculpture",
    alt_text: "Devils Tower overlooking the Circle of Sacred Smoke Sculpture",
    caption: "Devils Tower overlooking the Circle of Sacred Smoke Sculpture.",
    url: "https://www.nps.gov/common/uploads/structured_data/3C812F78-1DD8-B71B-0B434971F59DAE06.jpg",
    park_id: 27
  },
  {
    credit: "NPS Photo",
    title: "Aerial view of the Dry Tortugas",
    alt_text: "An aerial view of the Dry Tortugas",
  ...
  },
  {
    ...
    alt_text: "A view of Fort Jefferson from the moat all.",
    caption: "Fort Jefferson is a massive but unfinished coastal fortress. It is the largest masonry structure in the Americas, and is composed of over 16 million bricks.",
  ...
  },
  {
    ...
    alt_text: "Two divers dive the Windjammer Wreck",
  ...
  },
  {
    ...
    alt_text: "Park visitors enjoy a sunset on the moat wall.",
  ...
  },
  {
    ...
    alt_text: "A boat passes in front of Loggerhead Key during sunset",
  ...
  },
  {
    ...
    alt_text: "An aerial view of the landscape transition from Sawgrass to Florida Bay",
  ...
  },
  {
    ...
    alt_text: "Two visitors bike along the road in Shark Valley",
  ...
  },
  {
    ...
    alt_text: "A sunset creates a silhouette of a cypress tree with needle-like leaves that is shaped like an 'N'.",
    caption: "Cypress Tree Sunrise",
  ...
  },
  {
    ...
    alt_text: "An American Alligator high walks the Anhinga Trail.",
  ...
  },
  {
    ...
    alt_text: "Three tents are put up along the Long Pine Key campsite.",
  ...
  },
  {
    ...
    title: "Alatna River",
    alt_text: "Aerial view of the Alatna River as it winds through a valley",
  ...
  },
  {
    ...
    alt_text: "Alpenglow on the granite cliffs of mountains",
  ...
  },
  {
    ...
    alt_text: "A hiker crosses a stream with mountains in the background",
  ...
  },
  {
    ...
    title: "Blueberries",
    alt_text: "Handful of blueberries",
  ...
  },
  {
    ...
    alt_text: "Two hikers climb up a mountain pass",
  ...
  },
  {
    ...
    alt_text: "The Gateway Arch and Old Courthouse with a row of pink blooming cherry trees in front",
  ...
  },
  {
    ...
    alt_text: "Gateway Arch at Sunrise",
  ...
  },
  {
    ...
    alt_text: "The Gateway Arch reflected in the waters of of the north pond",
  ...
  },
  {
    ...
    alt_text: "Icebergs, calved from tidewater glaciers are a common sight in Glacier Bay National Park.",
  ...
  },
  {
    ...
    alt_text: "Beachcombing Brown Bear",
  ...
  },
  {
    ...
    alt_text: "Sheltered waters of Glacier Bay",
  ...
  },
  {
    ...
    alt_text: "Camping in the Glacier Bay backcountry",
  ...
  },
  {
    ...
    alt_text: "View of St. Mary Lake from Wild Goose Island Overlook",
  ...
  },
  {
    ...
    alt_text: "View of the mountains behind Lake McDonald at sunset",
  ...
  },
  {
    ...
    alt_text: "Looking down into the lobby of the Lake McDonald Lodge from the balcony",
  ...
  },
  {
    ...
    alt_text: "Closeup shot of Alcatraz Island showing lighthouse and prison with yellow flowers on slope in front.",
  ...
  },
  {
    ...
    alt_text: "View south with family on road in foreground and Rodeo Beach and cove in front of Point Bonita.",
  ...
  },
  {
    ...
    alt_text: "Orange Golden Gate Bridge with waves crashing in foreground and storm clouds behind",
  ...
  },
  {
    ...
    alt_text: "View over the Pacific from Bolinas Ridge; Stinson Beach, Bolinas Lagoon and head in mid-ground.",
  ...
  },
  {
    ...
    alt_text: "Mori Point view north with yellow an blue flowers, the blue-green Pacific Ocean and Mt. Tamalpais",
  ...
  },
  {
    ...
    alt_text: "The canyon glows orange as people visit Mather Point, a rock outcropping that juts into Grand Canyon",
  ...
  },
  {
    ...
    alt_text: "The Cape Royal viewpoint curves into the distance and closer rock formations jut into the canyon",
  ...
  },
  {
    ...
    alt_text: "The Desert View Watchtower looms 70 feet into the air over a vast and dramatic view of the canyon",
  ...
  },
  {
    ...
    alt_text: "Tall canyon walls frame the wide Colorado river weaving back and forth.",
  ...
  },
  {
    ...
    alt_text: "Winter sunrise on snow-covered Teton Range",
  ...
  },
  {
    credit: "NPS Photo / D. Lehle",
    title: "Grizzly Bear",
    alt_text: "Grizzly bear running through dry grass with shrubs behind",
  ...
  },
  {
    ...
    alt_text: "Lake Solitude with the high Teton Peaks beyond during summer",
  ...
  },
  {
    ...
    alt_text: "Historic Moulton Barn with visitors and the Teton Range beyond",
  ...
  },
  {
    ...
    title: "Moose",
    alt_text: "Bull moose with large antlers walking through fall grasses",
  ...
  },
  {
    credit: "NPS Photo",
    title: "Golden Eagle",
    alt_text: "Golden Eagle flying with wings spread wide",
  ...
  },
  {
    credit: "Charlie Reed",
    title: "Comet NEOWISE",
    alt_text: "Ancient bristlecone with comet NEOWISE in the background",
  ...
  },
  {
    ...
    alt_text: "blue sky with green trees in mountain cirque",
  ...
  },
  {
    ...
    alt_text: "Colorful Milky Way over the red lit Lehman Caves Visitor Center",
  ...
  },
  {
    ...
    alt_text: "Snow covered mountains with brown trees in the foreground",
  ...
  },
  {
    ...
    alt_text: "A teen girl sits on a floatation device",
  ...
  },
  {
    ...
    alt_text: "Gold cottonwood trees, large dunes, a silver cloud, and snow-capped mountain",
  ...
  },
  {
    ...
    alt_text: "Grasslands, large dunes, and snow-capped peaks at sunset",
  ...
  },
  {
    ...
    alt_text: "Elk, Grasslands, Dunes, and Sangre de Cristo Mountains",
  ...
  },
  {
    ...
    alt_text: "Lower Sand Creek Lake, Great Sand Dunes National Preserve",
  ...
  },
  {
    ...
    title: "Mist Rising From the Mountains",
    alt_text: "Wisps of fog hang over the forests in the mountains.",
  ...
  },
  {
    ...
    alt_text: "Rhododendron bushes line the banks of a stream filled with large boulders.",
  ...
  },
  {
    ...
    alt_text: "A hillside in the forest covered with white trillium flowers",
  ...
  },
  {
    ...
    alt_text: "Bright gold and red leaves shine through the fog in a forest",
  ...
  },
  {
    ...
    alt_text: "Gold and red fall colors fill the valleys while snow coats the mountain tops.",
  ...
  },
  {
    credit: "NPS/Bieri",
    title: "El Capitan",
    alt_text: "El Capitan with blooming claret cup cacti",
  ...
  },
  {
    ...
    alt_text: "the slat flats become flooded during monsoon months after large rain events.",
  ...
  },
  {
    ...
    alt_text: "Fall colors in Devil's Hall",
  ...
  },
  {
    credit: "NPS/Buehler",
    title: "Pratt Cabin",
    alt_text: "Pratt Cabin in McKittrick Canyon",
    caption: "Pratt Cabin is nestled in McKittrick Canyon with abundant trees.",
  ...
  },
  {
    ...
    alt_text: "wildflowers blossom along The Bowl trail",
  ...
  },
  {
    ...
    alt_text: "Ahinahina blooms in Haleakala crater",
  ...
  },
  {
    ...
    alt_text: "Waimoku waterfall in the park's Kipahulu District",
  ...
  {
    credit: "NPS",
    title: "The Pools of Oheo in the park's Kipahulu District",
    alt_text: "The Pools of Oheo in the park's Kipahulu District",
    caption: "The Pools of Oheo in the park's Kipahulu District.",
  ...
  },
  {
    ...
    alt_text: "Sun setting over the volcano crater and horizon",
  ...
  },
  {
    ...
    title: "Hōlei Pali",
    alt_text: "Lava flows and ferns in front of a cliff at sunset",
  ...
  },
  {
    credit: "NPS Photo/A. LaValle",
    title: "Tide Pools",
    alt_text: "Green vegetation in tide pools on a rocky ocean coastline",
  ...
  },
  {
    credit: "NPS Photo/A. LaValle",
    title: "Lava Trees",
    alt_text: "A lava tree in a black lava field with small living trees and a rainbow behind",
  ...
  },
  {
    ...
    title: "Halapē",
    alt_text: "Rocky coastline with palm trees and a cliff beyond",
  ...
  },
  {
    ...
    title: "Kīlauea Iki",
    alt_text: "A cloud-filled volcanic crater at sunrise with a mountain rising behind",
